    ...
    <div className="mx-25 mt-8 flex gap-5">
      ...
      <div className="w-[30%]">
        ...
        <div className="flex flex-wrap gap-3 mt-3">
          <div
            className={`border rounded-lg px-2 flex items-center mt-2 cursor-pointer hover:bg-accent ${!genreId ? "bg-accent font-bold" : ""}`}
          ...
          {genres.map((genre) => (
            <div
              key={genre.id}
              className={`border rounded-lg px-2 flex items-center mt-2 cursor-pointer hover:bg-accent ${Number(genreId) === genre.id ? "bg-accent font-bold" : ""}`}
...
const Home = () => {
  return (
    <>
      ...
      <Suspense fallback={<div className="mx-25 mt-8">Loading...</div>}>
        <SearchContent />
      </Suspense>
      <Footer />
    </>
